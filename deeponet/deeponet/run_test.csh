...
gfortran deeponet.f90 -o exec -g -fbounds-check -I${topdir}/pytorch-lib/lib/python3.10/site-packages/torch/include -I${topdir}/pytorch-fortran/gnu/install/include/mod_files -L${topdir}/pytorch-lib/lib/python3.10/site-packages/torch/lib -lpytorch_fort_proxy -lpytorch_proxy 
