...
readonly PROJECT="m3780" #"m4723" #"m4506"
readonly compiler=""

# Simulation
readonly COMPSET="20TRSOI_EAM%CMIP6_ELM%SPBC_MPASSI_MPASO_MOSART_SGLC_WW3%sp36x36"
...
readonly CASE_NAME="v2_1REV.WCYCL20TR-WW3.${RESOLUTION}"

# Run options
readonly MODEL_START_TYPE='continue' #"initial"  # 'initial', 'continue', 'branch', 'hybrid'
readonly START_DATE="1978-01-01"

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=FALSE #TRUE
...
# Set paths
readonly CODE_ROOT="/pscratch/sd/z/zhan391/WW3/E3SMv2.1"
...
create_newcase() {
  ...
  ### Added by Shixuan for ww3######################
  #maximum allowed ntasks is 36x36 = 1296 for ww3
  ./xmlchange NTASKS=1
  ./xmlchange NTHRDS=1
  ./xmlchange ROOTPE=0
  ...
  ./xmlchange ATM_NTASKS=5400  #let atm run on all CPU
  ./xmlchange CPL_NTASKS=3120  # CPL + OCN + WAV = ATM 
  ./xmlchange OCN_NTASKS=1200  # OCN_NTASKS + OCN_ROOTPE = WAV_ROOTPE 
  ./xmlchange OCN_ROOTPE=3120
  
  ./xmlchange LND_NTASKS=1200  
  ./xmlchange LND_ROOTPE=1920
  
  ./xmlchange ROF_NTASKS=1200
  ./xmlchange ROF_ROOTPE=1920

  ./xmlchange ICE_NTASKS=1920
  ./xmlchange WAV_NTASKS=1080  
  ./xmlchange WAV_ROOTPE=4320
